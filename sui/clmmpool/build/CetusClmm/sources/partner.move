...
module cetus_clmm::partner {
    ...
    /// The partners is hold in vec_map.
    /// Key is partner name, value is partner id.
    ...
    /// The partner info include the partner name, ref fee rate, time range and balances.
    /// The Bag is used to store the partner fee of different coins.
